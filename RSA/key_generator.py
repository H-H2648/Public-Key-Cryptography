from utils.helpers import generate_random_prime, generate_random_coprime, gcd_multiplicative_inverse
...
class Key_Generator:
    ...
    def get_key(self):
        ...
        _, self.secret_exponent = gcd_multiplicative_inverse(self.public_exponent, self.phi_public_modulus)
